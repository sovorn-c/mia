...
> The exception below is historical infrastructure context. It does not waive the e12 release gate or introduce a new security exception.
...
## e12 CLI-Only Frontend Cleanup

No new security exception was required. The e12 follow-up review covered the CLI/REPL, package, artifact, documentation, and deleted frontend boundaries; the release gate and full test suite passed.
