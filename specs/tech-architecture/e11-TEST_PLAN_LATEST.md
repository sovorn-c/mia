...
| SC-e11s02-P0-02 | The wheel contains the required packages and supported CLI/REPL surface, excludes retired packages, and exposes the declared Plugin API version | P0 | Integration | `scripts/check-wheel-surface.py`, `tests/test_release_artifacts.py` |
